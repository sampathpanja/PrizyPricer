...
public class ManageProductController {
	...
	@RequestMapping(path = "/add-product.htm", method = RequestMethod.GET)
	public String addProduct(Model model, @ModelAttribute("product") ProductCommand command) {
		return "add-product";
	}

	@RequestMapping(path = "/add-product.htm", method = RequestMethod.POST)
	public String saveProduct(Model model, @ModelAttribute("product") ProductCommand command) {
		...
		int productId = service.addProduct(productBo);
